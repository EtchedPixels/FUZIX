export CROSS_AS=fcc -mz8 -X -c
export CROSS_LD=ldz8
export CROSS_CC=fcc
export CROSS_CCOPTS= -X -mz8 -c -Os -I$(ROOT_DIR)/cpu-$(CPU) -I$(ROOT_DIR)/platform/platform-$(TARGET) -I$(ROOT_DIR)/include
