...
export CROSS_CCOPTS=-c -Os -fno-strict-aliasing -fomit-frame-pointer -fno-builtin -Wall -I$(ROOT_DIR)/cpu-lx106 -I$(ROOT_DIR)/platform-$(TARGET) -I$(ROOT_DIR)/include -mlongcalls
