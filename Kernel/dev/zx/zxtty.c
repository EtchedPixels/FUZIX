/*
 *	TTY driver for general ZX spectrum style systems
 *
 *	Set CONFIG_GFXBASE if the video is directly mapped
 *	Set CONFIG_TIMEX if Timex modes are available
 */
#include <kernel.h>
#include <kdata.h>
#include <printf.h>
