...
extern void w5100_bread(uint16_t off, void *p, uint16_t n);
/* Read a block to current user space keeping byte order */
extern void w5100_breadu(uint16_t off, void *p, uint16_t n);
...
extern void w5100_bwrite(uint16_t off, void *p, uint16_t n);
extern void w5100_bwriteu(uint16_t off, void *p, uint16_t n);
