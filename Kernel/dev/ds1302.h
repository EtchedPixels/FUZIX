...
void ds1302_set_pin_clk(bool state) __z88dk_fastcall;
void ds1302_set_pin_ce(bool state) __z88dk_fastcall;
void ds1302_set_pin_data(bool state) __z88dk_fastcall;
bool ds1302_get_pin_data(void);
void ds1302_set_pin_data_driven(bool state) __z88dk_fastcall; /* 0=tristate for input, 1=driven for output */
#endif
