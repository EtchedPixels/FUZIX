...
/* 68HC811 memory configuration. Right now we are putting I/O at 0 and
   thus the RAM starts at 0x0040 for 0x00C0 for page (plenty of room) */
MEMORY
{
  ports (rw)  : ORIGIN = 0x00000, LENGTH = 0x0040
  page0 (rwx) : ORIGIN = 0x00040, LENGTH = 0x00C0
  ram   (rwx) : ORIGIN = 0x00200, LENGTH = 0xF600
