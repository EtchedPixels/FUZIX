...
export CROSS_CCOPTS=-c -g -Os -fno-strict-aliasing -fomit-frame-pointer -fno-builtin -Wall -I$(ROOT_DIR)/cpu-esp32 -I$(ROOT_DIR)/platform-$(TARGET) -I$(ROOT_DIR)/include -I$(ROOT_DIR) -I$(FUZIX_ROOT)/Library/include/esp32/ -I$(FUZIX_ROOT)/Library/include/ -mlongcalls -mforce-l32 -mforce-no-pic -mtext-section-literals -fstrict-volatile-bitfields
