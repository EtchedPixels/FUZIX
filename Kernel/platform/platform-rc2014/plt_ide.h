...
extern uint_fast8_t ppide_read(uint_fast8_t regaddr);
extern void ppide_write(uint_fast8_t regaddr, uint_fast8_t val);
extern void ppide_read_data(uint8_t *dptr);
extern void ppide_write_data(uint8_t *dptr);
