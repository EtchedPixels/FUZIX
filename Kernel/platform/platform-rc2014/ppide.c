...
uint_fast8_t ppide_read(uint_fast8_t regaddr)
{
    uint8_t r;
...
void ppide_write(uint_fast8_t regaddr, uint_fast8_t value)
{
...
void ppide_read_data(uint8_t *addr) __naked
{
    __asm
#ifdef CONFIG_BANKED
            pop bc
...
void ppide_write_data(uint8_t *addr) __naked
{
    __asm
#ifdef CONFIG_BANKED
            pop bc
