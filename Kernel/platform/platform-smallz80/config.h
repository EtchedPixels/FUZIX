 ...
 */
#define PROGBASE    0x4000  /* Base of user  */
#define PROGLOAD    0x4000  /* Load and run here */
...
#define SWAPBASE    0x4000	/* We swap the lot in one, include the */
...
/* Could be up to 4 if we ever deal with the add on board */
