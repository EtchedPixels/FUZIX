...
#define PROGTOP     0xE000  /* Top of program, udata stash follows */
#define PROC_SIZE   56 	    /* Memory needed per process */

#define SWAP_SIZE   0x70 	/* 48K in blocks (to get the udata stash) */
...
/* Device parameters */
#define NUM_DEV_TTY 1	  /* For now just the console */
