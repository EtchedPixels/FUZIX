...
bankout:
	...
	andb #0xF0
	orb #0x08
	stb $E7C9		; set bank for A000-DFFF
	pshs x,y
...
bankin:
	...
	anda	#0xF0
	ora	#0x08
	sta $E7C9		; map it at A000-DFFF for copying
	ldx #$A100
	ldy #$6100
bankin_cp:
	ldd ,x++
...
;
	...
	rolb
	andb #0xF0
	orb #0x08			; parent low page
	stb 0xE7C9			; make it appear at A000
...
save_low:				; copy the low 16K of user
	...
	; This is nasty copy the high page. We can't do this
	; the easy way as we don't have a way to map both pages at once
	lda U_DATA__U_PAGE
	ldx #$A000
	ldb _cur6
	andb #0xF0
...
patch2:
	; to child
	stb 0xE7C9			; map the child properly into A000-DFFF
	exg d,u
	std ,x++
	exg d,u
	cmpx #0xE000
