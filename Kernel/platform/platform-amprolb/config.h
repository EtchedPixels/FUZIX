...
#define PROGTOP     0xB000  /* Top of program */
#define KERNTOP	    0xFE00  /* common grows from C000, buffers above*/
                            /* 512 bytes of serial buffers */

#define PROC_SIZE   48	  /* Memory needed per process */

#define SWAPDEV     (swap_dev)	/* A variable for dynamic, or a device major/minor */
extern uint16_t swap_dev;
#define SWAP_SIZE   0x59 	/* 44.5K in blocks (prog + udata) */
#define SWAPBASE    0x0000	/* start at the base of user mem */
#define SWAPTOP	    0xB000	/* Swap out program */
